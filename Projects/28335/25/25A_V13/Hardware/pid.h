...
//#pragma CODE_SECTION(PID_Init, ".TI.ramfunc");
//#pragma CODE_SECTION(PID_Set, ".TI.ramfunc");
//#pragma CODE_SECTION(PID_Change_Kp, ".TI.ramfunc");
//#pragma CODE_SECTION(PID_Change_Ki, ".TI.ramfunc");
//#pragma CODE_SECTION(PID_Change_Kd, ".TI.ramfunc");
//#pragma CODE_SECTION(PID_Change_Output_Clamp, ".TI.ramfunc");
//#pragma CODE_SECTION(PID_Change_Int_Clamp, ".TI.ramfunc");
//#pragma CODE_SECTION(PID_Run, ".TI.ramfunc");
