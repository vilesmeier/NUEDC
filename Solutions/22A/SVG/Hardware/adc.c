...
void ADC_Get_Value(void)
{
    ...
    state.V_Input  = ((AdcRegs.ADCRESULT0 >> 4) * 0.000732421875f - 1.49998f) * 31.0f;
    //ADCResult1 - Input     AC Current - B0
    state.I_Input  = ((AdcRegs.ADCRESULT1 >> 4) * 0.000732421875f - 1.49998f) * 4.166667f;
    ...
    state.I_DC     = ((AdcRegs.ADCRESULT3 >> 4) * 0.000732421875f - 1.49998f) * 4.166667f;
}
