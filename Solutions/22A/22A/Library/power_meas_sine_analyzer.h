...
// $Release Date: Tue Jun 25 17:15:04 CDT 2024 $
// $Copyright:
...
//! \return None
//!
static inline void POWER_MEAS_SINE_ANALYZER_Init(POWER_MEAS_SINE_ANALYZER *v)
{
    v->vRms=0;
    v->vAvg=0;
    v->vEma=0;
...
//! \return None
//!
static inline void POWER_MEAS_SINE_ANALYZER_Set(POWER_MEAS_SINE_ANALYZER *v,
