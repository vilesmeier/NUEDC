...
{
    state.V_output = (AdcMirror.ADCRESULT0 * 0.0007326007326f - 1.49999f) * 30.8f;
...
//        }
    ...
    {
        //PR
        PR_Run(&pr_Vol,state.V_set_rms * SQUARE_2 * sinf(ramp.ref_angle),state.V_output,-state.I_output);
