...
void main(void)
{
    ...
    // RECTIFIER------------------------------------------------------------------------------
    PR_Init(&pr_rec_a);
    PR_Set(&pr_rec_a,2.0f,65.0f,5.0f,100*PI,VDC,20000);
    PR_Init(&pr_rec_c);
    PR_Set(&pr_rec_c,2.0f,65.0f,5.0f,100*PI,VDC,20000);
...
//        // 实际 2.3A过流
//        if(rms_I_load.sample_rms > 1.29f)
//        {
//            state.flag.bits.FLAG_INV_OC = ERR_OC;
//            EPWM_AQ_Inverter_SoftForce_LOW();
//        }
//
//        // OC delay
//        if(state.flag.bits.FLAG_INV_OC == ERR_OC)
//        {
//            state.OST_Delay = state.OST_Delay + 1;
//        }
//
//        // clear status
//        if(state.OST_Delay >= 40000)
//        {
//            state.OST_Delay = 0;
//            EPWM_AQ_Inverter_SoftForce_OFF();
//            state.flag.bits.FLAG_INV_OC = ERR_NONE;
//        }
