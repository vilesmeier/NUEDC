...
//#pragma CODE_SECTION(UART_Init, ".TI.ramfunc");
//#pragma CODE_SECTION(UART_CMD_Init, ".TI.ramfunc");
//#pragma CODE_SECTION(UART_Set, ".TI.ramfunc");
//#pragma CODE_SECTION(UART_SendChar, ".TI.ramfunc");
//#pragma CODE_SECTION(UART_ReceiveChar, ".TI.ramfunc");
#pragma CODE_SECTION(UART_VOFA_1Ch_ShowFloat, ".TI.ramfunc");
#pragma CODE_SECTION(UART_VOFA_2Ch_ShowFloat, ".TI.ramfunc");
#pragma CODE_SECTION(UART_VOFA_3Ch_ShowFloat, ".TI.ramfunc");
