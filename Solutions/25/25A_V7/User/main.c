...
//    memcpy(&RamfuncsRunStart, &RamfuncsLoadStart, (Uint32)&RamfuncsLoadSize);
    ...
    PR_Init(&pr_rec_a);
    PR_Set(&pr_rec_a,4.3f,65.0f,5.0f,100*PI,VDC,20000);
    PR_Init(&pr_rec_c);
    PR_Set(&pr_rec_c,4.3f,65.0f,5.0f,100*PI,VDC,20000);
...
//        }
        ...
        // vofa debug
        UART_VOFA_3Ch_ShowFloat(state.I_In_a, state.I_In_c, pr_rec_a.out);
