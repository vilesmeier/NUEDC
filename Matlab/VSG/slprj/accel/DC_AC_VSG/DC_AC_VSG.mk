...
## Final product: ./DC_AC_VSG_acc.lib
...
%.obj : $(START_DIR)/slprj/accel/DC_AC_VSG/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/DC_AC_VSG/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/DC_AC_VSG/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/DC_AC_VSG/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/DC_AC_VSG/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
