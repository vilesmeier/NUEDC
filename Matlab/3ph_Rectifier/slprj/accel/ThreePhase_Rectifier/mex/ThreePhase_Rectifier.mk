###########################################################################
## Makefile generated for component 'ThreePhase_Rectifier'. 
## 
## Makefile     : ThreePhase_Rectifier.mk
## Generated on : Mon Jul 28 21:18:06 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ThreePhase_Rectifier_acc.mexw64
...
PRODUCT_NAME              = ThreePhase_Rectifier
MAKEFILE                  = ThreePhase_Rectifier.mk
MATLAB_ROOT               = D:/MATLAB
MATLAB_BIN                = D:/MATLAB/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/NUEDC/Matlab/3ph_Rectifier
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = ThreePhase_Rectifier_comp.rsp
CMD_FILE                  = ThreePhase_Rectifier.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ThreePhase_Rectifier_acc.mexw64
...
DEFINES_STANDARD = -DMODEL=ThreePhase_Rectifier -DNUMST=3 -DNCSTATES=54 -DHAVESTDIO -DMDL_REF_SIM_TGT=1
...
SRCS = $(START_DIR)/slprj/accel/ThreePhase_Rectifier/ThreePhase_Rectifier_acc.c $(START_DIR)/slprj/accel/ThreePhase_Rectifier/ThreePhase_Rectifier_acc_data.c $(START_DIR)/slprj/accel/ThreePhase_Rectifier/rt_nonfinite.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = ThreePhase_Rectifier_acc.obj ThreePhase_Rectifier_acc_data.obj rt_nonfinite.obj c_mexapi_version.obj
...
ThreePhase_Rectifier_acc.obj : $(START_DIR)/slprj/accel/ThreePhase_Rectifier/ThreePhase_Rectifier_acc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ThreePhase_Rectifier_acc_data.obj : $(START_DIR)/slprj/accel/ThreePhase_Rectifier/ThreePhase_Rectifier_acc_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/accel/ThreePhase_Rectifier/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
