...
## Generated on : Mon Jul 28 21:18:04 2025
## Final product: ./ThreePhase_Rectifier_acc.lib
...
PRODUCT = ./ThreePhase_Rectifier_acc.lib
...
%.obj : $(START_DIR)/slprj/accel/ThreePhase_Rectifier/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/ThreePhase_Rectifier/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/ThreePhase_Rectifier/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/ThreePhase_Rectifier/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/ThreePhase_Rectifier/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
